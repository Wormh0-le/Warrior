...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Status_Rage_Empty, "Player.Status.Rage.Empty");
	...
	UE_DEFINE_GAMEPLAY_TAG(Enemy_Ability_SpawnDrops, "Enemy.Ability.SpawnDrops");

	UE_DEFINE_GAMEPLAY_TAG(Enemy_Event_SummonEnemies, "Enemy.Event.SummonEnemies");

	UE_DEFINE_GAMEPLAY_TAG(Enemy_Status_Alert, "Enemy.Status.Alert");	// stateTree demo
